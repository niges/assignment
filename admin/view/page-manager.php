			...
			<div class="col-md-10">
				...
				<form method="post">
					<table class="table table-bordered">
						...
						<tr>
							<td>Body:<textarea name="body" rows="10" cols="100" class="form-control ckeditor" ><?php echo $value['body'] ?></textarea></td>
						</tr>
						<tr>
							<td>
				...
				<form method="post">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>
								<a href="<?php echo $url['server_root']; ?>admin/view/page-manager.php/?update=1&id=<?php echo $value['id'] ?>" class="btn btn-primary" name="edit">Edit</a>
							</td>
							<td>
							...
							<td><a href="<?php echo $url['server_root']; ?>admin/view/images-files.php/?show=1&id=<?php echo $value['id'] ?>" class="btn btn-success">View Image</a>
							</td>
